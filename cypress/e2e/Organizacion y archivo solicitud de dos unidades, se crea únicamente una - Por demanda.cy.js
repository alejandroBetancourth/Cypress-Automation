...
//pruebas05, puebas.jbpm07, se le quita rol archivista
//pruebas03, puebas.jbpm08, se le asigna rol archivista 
const env = Cypress.env(Cypress.env('ambiente'));

describe('Organizacion y archivo solicitud de dos unidades, se crea únicamente una - Por demanda', () => {
  beforeEach(() => {
  ...
  it('Flujo número 14', { defaultCommandTimeout: 40000 }, () => {
    ...
    cy.wait(1000);
    seleccionarDependencia('Secretaria General', 'Secretaria General');
