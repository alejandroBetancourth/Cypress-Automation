...
describe('Producción documental externa sin archivo - Por flujo sin revisor', () => {
  let radicadoE;
  let radicadoS;
  before(() => {
  ...
  it('Flujo número 28', { defaultCommandTimeout: 40000 }, () => {
    ...
    cy.iframe().find('#subject').type("Prueba flujo completo otros documentos sin revisor");
